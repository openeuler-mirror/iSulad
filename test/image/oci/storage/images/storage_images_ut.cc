...
/********************************test data *************************************************
{
  ...
  "names": [
    "isula.org/library/health_check:latest"
  ],
  "layer": "6194458b07fcf01f1483d96cd6c34302ffff7f382bb151a6d023c4e80ba3050a",
  "metadata": "{}",
  "big-data-names": [
...
TEST_F(StorageImagesUnitTest, test_image_store_create)
{
    ...
    const char *names[] = { "isula.org/library/health_check:latest" };
    ...
    ASSERT_EQ(image->repo_tags_len, 1);
    ASSERT_STREQ(image->repo_tags[0], "isula.org/library/health_check:latest");
    ...
    ASSERT_STREQ(
        image->repo_digests[0],
        "isula.org/library/health_check@sha256:fdb7b1fccaaa535cb8211a194dd6314acc643f3a36d1a7d2b79c299a9173fa7e");
