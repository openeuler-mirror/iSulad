...
static void ModifyHostNetworkOptionForContainer(const runtime::v1::NamespaceMode &hostNetwork,
                                                const std::string &podSandboxID, host_config *hostConfig)
{
    ...
    if (hostNetwork == runtime::v1::NamespaceMode::NODE) {
                                            ...
                                            const std::string &podSandboxID, host_config *hostConfig)
{
    ...
    if (nsOpts.pid() == runtime::v1::NamespaceMode::TARGET) {
