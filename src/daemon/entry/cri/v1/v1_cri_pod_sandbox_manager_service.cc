...
void PodSandboxManagerService::ApplySandboxLinuxOptions(const runtime::v1::LinuxPodSandboxConfig &lc,
...
void PodSandboxManagerService::ApplySandboxResources(const runtime::v1::LinuxPodSandboxConfig *lc,
                                                     host_config *hc, Errors & /* error */)
{
    ...
    if (lc != nullptr && lc->has_resources()) {
        const runtime::v1::LinuxContainerResources &res = lc->resources();
...
void PodSandboxManagerService::MakeSandboxIsuladConfig(const runtime::v1::PodSandboxConfig &c, host_config *hc,
                                                       container_config *custom_config, Errors &error)
{
    ...
    const ::runtime::v1::LinuxSandboxSecurityContext &context = c.linux().security_context();
    ...
    CRIHelpersV1::AddSecurityOptsToHostConfig(securityOpts, hc, error);
    if (error.NotEmpty()) {
...
container_create_request *PodSandboxManagerService::PackCreateContainerRequest(
    const runtime::v1::PodSandboxConfig &config, const std::string &image, host_config *hostconfig,
    container_config *custom_config, const std::string &runtimeHandler, Errors &error)
{
    ...
    std::string sandboxName = CRINamingV1::MakeSandboxName(config.metadata());
...
PodSandboxManagerService::GenerateSandboxCreateContainerRequest(const runtime::v1::PodSandboxConfig &config,
...
auto PodSandboxManagerService::CreateSandboxContainer(const runtime::v1::PodSandboxConfig &config,
                                                      const std::string &image, std::string &jsonCheckpoint,
...
void PodSandboxManagerService::GetSandboxNetworkInfo(const runtime::v1::PodSandboxConfig &config,
...
void PodSandboxManagerService::SetupSandboxNetwork(const runtime::v1::PodSandboxConfig &config,
