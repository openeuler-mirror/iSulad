 ...
 *********************************************************************************/
#ifndef DAEMON_ENTRY_CRI_V1_IMAGE_MANAGER_SERVICE_H
#define DAEMON_ENTRY_CRI_V1_IMAGE_MANAGER_SERVICE_H
#include <memory>
#include <string>
#include <vector>
...
public:
    ...
    virtual auto PullImage(const runtime::v1::ImageSpec &image, const runtime::v1::AuthConfig &auth,
...
#endif // DAEMON_ENTRY_CRI_V1_IMAGE_MANAGER_SERVICE_H
