 ...
 * Author: wujing
 * Start: 2022-06-24
 * Description: define grpc container resume service functions
 ******************************************************************************/
#ifndef DAEMON_ENTRY_CONNECT_GRPC_CONTAINER_RESUME_SERVICE_H
#define DAEMON_ENTRY_CONNECT_GRPC_CONTAINER_RESUME_SERVICE_H
...
public:
    ...
    ContainerResumeService &operator=(const ContainerResumeService &) = delete;
    ~ContainerResumeService() = default;
...
protected:
    ...
    int FillRequestFromgRPC(const ResumeRequest *request, void *containerReq) override;
    void ServiceRun(service_executor_t *cb, void *containerReq, void *containerRes) override;
    void FillResponseTogRPC(void *containerRes, ResumeResponse *reply) override;
    void CleanUp(void *containerReq, void *containerRes) override;
};

#endif // DAEMON_ENTRY_CONNECT_GRPC_CONTAINER_RESUME_SERVICE_H
