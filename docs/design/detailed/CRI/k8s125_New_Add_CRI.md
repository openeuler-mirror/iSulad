...
##1.5、ImageFsInfo##
ImageFsInfo(std::vector<std::unique_ptr<runtime::v1alpha2::FilesystemUsage>> *usages, Errors &error) override->void

**新增CRI字段**

FilesystemUsage无新增，不需要补充CRI字段
#2、POD#
##2.1、RunPodSandbox##
